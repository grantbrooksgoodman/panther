...
public extension AppTheme {
    ...
    static let prevaricationMode: AppTheme = .init(.init(name: "Prevarication Mode", items: prevaricationModeColoredItems))
    ...
    private static var prevaricationModeColoredItems: [Item] {
        let accentColor = UIColor.systemBlue // Plan A
        // let accentColor = UIColor.systemGreen // Plan B
        let senderBubbleColor = UIColor.systemGreen
